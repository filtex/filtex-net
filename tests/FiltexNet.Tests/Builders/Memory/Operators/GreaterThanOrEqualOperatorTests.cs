...
namespace FiltexNet.Tests.Builders.Memory.Operators
{
    public class GreaterThanOrEqualOperatorTests
    {
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsNumberAndNull()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeNumber, "Value", (decimal)100);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsNumberAndLess()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeNumber, "Value", value + 1);
        ...
        [Fact]
        public void Build_ShouldReturnTrue_WhenFieldTypeIsNumberAndEqual()
        {
            // Arrange
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsDateAndNull()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeDate, "Value", DateTime.Now);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsDateAndLess()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeDate, "Value", value.AddDays(1));
        ...
        [Fact]
        public void Build_ShouldReturnTrue_WhenFieldTypeIsDateAndEqual()
        {
            // Arrange
            var now = DateTime.UtcNow;
            var value = new DateTime(now.Year, now.Month, now.Day);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsTimeAndNull()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeTime, "Value", 60);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsTimeAndLess()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeTime, "Value", value + 1);
        ...
        [Fact]
        public void Build_ShouldReturnTrue_WhenFieldTypeIsTimeAndEqual()
        {
            // Arrange
            var value = 60;
            var data = MemoryUtils.ObjectToDictionary(new
        ...
        public void Build_ShouldReturnTrue_WhenFieldTypeIsTimeAndGreater()
        {
            ...
            var expression =
                GreaterThanOrEqualOperator.Build(FieldType.FieldTypeTime, "Value", value - 1);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsDateTimeAndNull()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeDateTime, "Value", DateTime.Now);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsDateTimeAndLess()
        {
            ...
            var expression = GreaterThanOrEqualOperator.Build(FieldType.FieldTypeDateTime, "Value", value.AddHours(24));
        ...
        [Fact]
        public void Build_ShouldReturnTrue_WhenFieldTypeIsDateTimeAndEqual()
        {
            // Arrange
            var now = DateTime.UtcNow;
            var value = new DateTime(now.Year, now.Month, now.Day, now.Hour, now.Minute, now.Second);
        ...
        public void Build_ShouldReturnTrue_WhenFieldTypeIsDateTimeAndGreater()
        {
            ...
            var expression =
                GreaterThanOrEqualOperator.Build(FieldType.FieldTypeDateTime, "Value", value.AddHours(-24));
