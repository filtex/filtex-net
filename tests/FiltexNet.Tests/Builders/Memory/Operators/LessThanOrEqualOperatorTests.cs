...
namespace FiltexNet.Tests.Builders.Memory.Operators
{
    public class LessThanOrEqualOperatorTests
    {
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsNumberAndNull()
        {
            ...
            var expression = LessThanOrEqualOperator.Build(FieldType.FieldTypeNumber, "Value", (decimal)100);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsDateAndNull()
        {
            ...
            var expression = LessThanOrEqualOperator.Build(FieldType.FieldTypeDate, "Value", DateTime.Now);
        ...
        public void Build_ShouldReturnTrue_WhenFieldTypeIsDateAndLess()
        {
            ...
            var expression = LessThanOrEqualOperator.Build(FieldType.FieldTypeDate, "Value", value.AddDays(1));
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsTimeAndNull()
        {
            ...
            var expression = LessThanOrEqualOperator.Build(FieldType.FieldTypeTime, "Value", 60);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsTimeAndGreater()
        {
            ...
            var expression =
                LessThanOrEqualOperator.Build(FieldType.FieldTypeTime, "Value", value - 1);
        ...
        public void Build_ShouldReturnFalse_WhenFieldTypeIsDateTimeAndNull()
        {
            ...
            var expression = LessThanOrEqualOperator.Build(FieldType.FieldTypeDateTime, "Value", DateTime.Now);
        ...
        public void Build_ShouldReturnTrue_WhenFieldTypeIsDateTimeAndLess()
        {
            ...
            var expression = LessThanOrEqualOperator.Build(FieldType.FieldTypeDateTime, "Value", value.AddHours(24));
