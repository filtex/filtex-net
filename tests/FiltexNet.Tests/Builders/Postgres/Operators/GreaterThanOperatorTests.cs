...
namespace FiltexNet.Tests.Builders.Postgres.Operators
{
    public class GreaterThanOperatorTests
    {
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsDate()
        {
            ...
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeDate, "Value", value, 1);
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsDateTime()
        {
            ...
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeDateTime, "Value", value, 1);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsString()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeString, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsStringArray()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeStringArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsNumberArray()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeNumberArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsBoolean()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeBoolean, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsBooleanArray()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeBooleanArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDateArray()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeDateArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsTimeArray()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeTimeArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDateTimeArray()
        {
            // Arrange
            // Act
            var expression = GreaterThanOperator.Build(FieldType.FieldTypeDateTimeArray, "Value", null, 0);
