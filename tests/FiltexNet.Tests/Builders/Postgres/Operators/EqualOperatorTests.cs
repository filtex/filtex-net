...
namespace FiltexNet.Tests.Builders.Postgres.Operators
{
    public class EqualOperatorTests
    {
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsString()
        {
            ...
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeString, "Value", value, 1);
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsNumber()
        {
            ...
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeNumber, "Value", value, 1);
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsBoolean()
        {
            ...
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeBoolean, "Value", value, 1);
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsDate()
        {
            ...
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeDate, "Value", value, 1);
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsDateTime()
        {
            ...
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeDateTime, "Value", value, 1);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsStringArray()
        {
            // Arrange
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeStringArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsNumberArray()
        {
            // Arrange
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeNumberArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsBooleanArray()
        {
            // Arrange
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeBooleanArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDateArray()
        {
            // Arrange
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeDateArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsTimeArray()
        {
            // Arrange
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeTimeArray, "Value", null, 0);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDateTimeArray()
        {
            // Arrange
            // Act
            var expression = EqualOperator.Build(FieldType.FieldTypeDateTimeArray, "Value", null, 0);
