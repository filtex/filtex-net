...
namespace FiltexNet.Tests.Builders.Mongo.Operators
{
    public class NotStartWithOperatorTests
    {
        ...
        public void Build_ShouldReturnExpression_WhenFieldTypeIsString()
        {
            ...
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeString, "Value", value);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsStringArray()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeStringArray, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsNumber()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeNumber, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsNumberArray()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeNumberArray, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsBoolean()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeBoolean, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsBooleanArray()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeBooleanArray, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDate()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeDate, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDateArray()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeDateArray, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsTime()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeTime, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsTimeArray()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeTimeArray, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDateTime()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeDateTime, "Value", null);
        ...
        public void Build_ShouldReturnNull_WhenFieldTypeIsDateTimeArray()
        {
            // Arrange
            // Act
            var expression = NotStartWithOperator.Build(FieldType.FieldTypeDateTimeArray, "Value", null);
